...
// FIXME dont hardcode SPI1
type Spi1Bus = Spi<'static, SPI1, Blocking>;
static SPI_BUS: StaticCell<Mutex<NoopRawMutex, RefCell<Spi1Bus>>> = StaticCell::new();
...
async fn main(_spawner: Spawner) {
    ...
    let spi_bus: &'static Mutex<NoopRawMutex, RefCell<Spi1Bus>> =
